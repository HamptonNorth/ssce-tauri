/**
 * Highlight Tool Property Card
 *
 * Properties:
 * - Colour (palette + custom + eyedropper)
 *
 * Note: Opacity is fixed at 30% - no UI control needed
 */
...
export class HighlightCard extends BasePropertyCard {
  constructor() {
  ...
  handleColourChange(colour) {
    ...
    setToolConfig("highlight", "colour", colour);
  }
